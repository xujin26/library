  	...
  	<div id="main">
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="borrow">
				<tr>
					<td>${borrow.id}</td>
					<td>${borrow.books[0].name}</td>
					<td>${borrow.books[0].author}</td>
					<td>${borrow.books[0].publish}</td>
					<td>${borrow.readers[0].name}</td>
					<td>${borrow.readers[0].tel}</td>
					<td>${borrow.readers[0].cardId}</td>
